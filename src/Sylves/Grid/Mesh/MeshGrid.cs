...
namespace Sylves
{
    ...
    public class MeshGrid : DataDrivenGrid
    {
        ...
        private class DualMapping : BasicDualMapping
        {
            ...
            public override (Cell cell, CellCorner inverseCorner)? ToDualPair(Cell cell, CellCorner corner)
            {
            ...
            public override (Cell cell, CellCorner inverseCorner)? ToBasePair(Cell cell, CellCorner corner)
            {
