...
namespace Sylves
{
    public struct Vector2Int
    {
        ...
        {
            get { switch (index) { case 0: return x; case 1: return y; default: throw new Exception(); } }
            set { switch (index) { case 0: x = value; break; case 1: y = value; break; break; default: throw new Exception(); } }
        }
