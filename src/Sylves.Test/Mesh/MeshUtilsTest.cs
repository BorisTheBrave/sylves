...
namespace Sylves.Test
{
    ...
    internal class MeshUtilsTest
    {
        ...
        [Test]
        public void TestIsPointInCube2()
        {
            var plane = TestMeshes.PlaneXY_I;

            QuadInterpolation.GetCorners(plane, 0, 0, true, -.5f, .5f, out var v1, out var v2, out var v3, out var v4, out var v5, out var v6, out var v7, out var v8);
            bool IsPointInCube(Vector3 p) => MeshUtils.IsPointInCube(p, v1, v2, v3, v4, v5, v6, v7, v8);
